...
//    }
    ...
    if(threeFieldSwitch < 40.0f)
    {
        ...
        for(uint i = 0; i < newFace1.size(); ++i)
        {
            qInfo()<<"NEW FACE 1: "<<newFace1[i];
        }
        qInfo()<<"----------------------";
        ...
        for(uint i = 0; i < newFace2.size(); ++i)
        {
            qInfo()<<"NEW FACE 2: "<<newFace2[i];
        }
        qInfo()<<"----------------------";
        ...
        for(uint i = 0; i < newFace3.size(); ++i)
        {
            qInfo()<<"NEW FACE 3: "<<newFace3[i];
        }
